package com.wxy.security.filter;


import com.fasterxml.jackson.databind.ObjectMapper;
import com.wxy.security.entity.SecurityUser;
import com.wxy.security.entity.User;
...
public class TokenLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public TokenLoginFilter(AuthenticationManager authenticationManager, TokenManager tokenManager, RedisTemplate redisTemplate) {
        ...
        this.setRequiresAuthenticationRequestMatcher(new AntPathRequestMatcher("/services_authority/admin/index/login","POST"));
    }
